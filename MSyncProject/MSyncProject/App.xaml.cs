...
using MSyncProject.Helpers;
using MSyncProject.Services;
using MSyncProject.Views;
using Xamarin.Forms;
using Xamarin.Forms.Xaml;

[assembly: XamlCompilation(XamlCompilationOptions.Compile)]
namespace MSyncProject
{
	public partial class App : Application
	{
		...
		public static string AzureMobileAppUrl = "https://MSyncApp.azurewebsites.net";
